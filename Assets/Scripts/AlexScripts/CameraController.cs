...
public class CameraController : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        _mainCamera.GetComponent<Transform>().position = Vector3.Lerp(_mainCamera.GetComponent<Transform>().position, _playerTransform.position + _playerTransform.forward * _ajustes.offset.z + _playerTransform.position * _ajustes.offset.y, 150 * Time.fixedDeltaTime);
